...
public class WalkieTalkieActivity extends Activity implements View.OnTouchListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                sipAddress = "lucasclarim@sip2sip.info";
                initiateCall();
            }
        });

        final Button cButton = (Button) findViewById(R.id.c_button);
        ...
        cameraview.loadUrl("http://143.107.235.41:5000");

        ToggleButton pushToTalkButton = (ToggleButton) findViewById(R.id.pushToTalk);
        pushToTalkButton.setVisibility(View.INVISIBLE);
    ...
    public void closeLocalProfile() {
        ...
        try {
            ...
            Log.d("y/onDestroy", "Failed to close local ", ee);
        }
    }
    ...
    public void initiateCall() {
        ...
        try {
            ...
            Log.i("y/InitiateCall", "Error when trying to close manager.", e);
            if (me != null) {
                try {
                    manager.close(me.getUriString());
                } catch (Exception ee) {
                    Log.i("y/InitiateCall",
